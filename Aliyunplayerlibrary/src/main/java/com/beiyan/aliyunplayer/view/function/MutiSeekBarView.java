package com.beiyan.aliyunplayer.view.function;
...
import com.beiyan.aliyunplayer.util.DensityUtils;
...
public class MutiSeekBarView extends AppCompatSeekBar {
    ...
    public MutiSeekBarView(@NonNull Context context) {
        super(context);
        init();
    }

    public MutiSeekBarView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MutiSeekBarView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
