...
public class MP3Recorder {
    ...
    public void setmRecordFile() {
        ...
        String externalPath = Environment.getExternalStorageDirectory()
                .getAbsolutePath();
        File directory = new File(externalPath + "/" + "AudioRecorder/" + str);
        if (!directory.exists()) {
            directory.mkdirs();
        }
        this.mRecordFile = new File(directory, "test.mp3");
    }
    ...
    public boolean checkRecorderPermission(){
        ...
        bufferSizeInBytes = AudioRecord.getMinBufferSize(DEFAULT_SAMPLING_RATE,
                AudioFormat.CHANNEL_IN_STEREO, AudioFormat.ENCODING_PCM_16BIT);
        AudioRecord audioRecord =  new AudioRecord(MediaRecorder.AudioSource.MIC, DEFAULT_SAMPLING_RATE,
